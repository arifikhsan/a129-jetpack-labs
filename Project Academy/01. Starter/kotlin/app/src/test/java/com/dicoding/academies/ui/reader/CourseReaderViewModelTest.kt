...
class CourseReaderViewModelTest {
    ...
    private val dummyCourse = DataDummy.generateDummyCourses().first()
    private val courseId = dummyCourse.courseId
    private val dummyModules = DataDummy.generateDummyModules(courseId)
    private val moduleId = dummyModules.first().moduleId
    ...
    fun setUp() {
        ...
        val dummyModule = dummyModules.first()
    ...
    fun getSelectedModule() {
        ...
        assertEquals(content, dummyModules.first().contentEntity?.content)
    }
}